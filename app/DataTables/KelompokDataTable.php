...
class KelompokDataTable extends DataTable
{
    /**
     ...
     */
    public function query(Kelompok $model): QueryBuilder
    {
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->orderBy(0)
            ->drawCallback("function() {" . file_get_contents(resource_path('views/pages/apps/generus-management/kelompok/columns/_draw-scripts.js')) . "}");
    }
