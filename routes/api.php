...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->post('/tps', [TpsApi::class, 'update']);

    // Route::middleware('auth:sanctum')->put('/tps', function (Request $request) {
    //     return app(TpsApi::class)->update($request);
    // });

    Route::middleware('auth:sanctum')->get('/tps', function (Request $request) {
        return app(TpsApi::class)->datatableList($request);
    });
    
   
    
    // Route::put('/tps', function (Request $request) {
    //     return app(TpsApi::class)->update($request);
    // });
    
    // Route::get('/tps/{id}', function ($id) {
    //     return app(TpsApi::class)->get($id);
    // });
